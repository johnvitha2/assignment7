...
stmt->execute(
"INSERT INTO Faculty7 (FacNo, FacFirstName, FacLastName, FacCity, FacState, FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode) "
...
stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (1111,'IS320','SUMMER',2020,'BLM302','10:30:00',NULL,'MW');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (1234,'IS320','FALL',2019,'BLM302','10:30:00','098-76-5432','MW');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (2222,'IS460','SUMMER',2019,'BLM412','13:30:00',NULL,'TTH');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (3333,'IS320','SPRING',2020,'BLM214','08:30:00','098-76-5432','MW');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (4321,'IS320','FALL',2019,'BLM214','15:30:00','098-76-5432','TTH');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (4444,'IS320','WINTER',2020,'BLM302','15:30:00','543-21-0987','TTH');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (5555,'FIN300','WINTER',2020,'BLM207','08:30:00','765-43-2109','MW');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (5678,'IS480','WINTER',2020,'BLM302','10:30:00','987-65-4321','MW');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (5679,'IS480','SPRING',2020,'BLM412','15:30:00','876-54-3210','TTH');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (6666,'FIN450','WINTER',2020,'BLM212','10:30:00','987-65-4321','TTH');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (7777,'FIN480','SPRING',2020,'BLM305','13:30:00','765-43-2109','MW');");

stmt->execute("INSERT INTO Offering7 (OfferNo, CourseNo, OffTerm, OffYear, OffLocation, OffTime, FacNo, OffDays) VALUES (8888,'IS320','SUMMER',2020,'BLM405','13:30:00','654-32-1098','MW');");
